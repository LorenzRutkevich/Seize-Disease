...
def create_model(num_classes: int = 81, pretrained: bool = True, coco_model: bool = False, ViT_Dict: dict = None, ):
    # Base
    ...
    net = ViT(  # Single-scale ViT backbone
        ...
        use_rel_pos=True,
        out_feature="last_feat",
    ) if ViT_Dict is None else ViT(**ViT_Dict)
...
if __name__ == '__main__':
    ...
    from utils import _assert_strides_are_log2_contiguous
    model = create_model(2, pretrained=True)
    summary(model)
