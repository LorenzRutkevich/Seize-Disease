...
if __name__ == "__main__":
    seg_root_dir = '/home/lorenz/JF/new_data/CRAG_v2/CRAG/train/JSON'
    circle_root_dir = '/home/lorenz/JF/new_data/CRAG_v2/CRAG/train/C_JSON'

    os.makedirs(circle_root_dir, exist_ok=True)
